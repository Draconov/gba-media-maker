...
func main() {
	...
	opt := ConvertOptions{InputPath: *in, OutputPath: *out, FFmpegPath: ff, Start: *start, End: *end, Speed: *speed, VBlanks: 6, FitMode: "crop", AudioMode: "mix", Volume: 1, RomTitle: "PORTABLE"}
