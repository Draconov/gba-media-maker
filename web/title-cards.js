...
function defaultTitleCardSettings(sourceName = "GBA VIDEO") {
  return {
...
function createTitleCardProject(sourceName = "GBA VIDEO") {
...
function normalizeTitleCardSettings(value = {}, sourceName = "GBA VIDEO", part = 1) {
...
function resolveTitleCardSettings(project, sourceName, part) {
...
function renderTitleCardPixels(backgroundRGB, rawSettings, part = 1, sourceName = "GBA VIDEO") {
...
function buildTitleCardAsset(backgroundRGB, rawSettings, part = 1, sourceName = "GBA VIDEO") {
...
function renderTitleCardPreview(canvas, source, fitMode, rawSettings, part = 1, sourceName = "GBA VIDEO") {
...
const TITLE_CARD_BYTES = HEADER_SIZE + WIDTH * HEIGHT * 2;
const TITLE_CARD_WIDTH = WIDTH;
